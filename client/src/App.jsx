...
function AppWrapper() {
  ...
  if (pathName === "/inbox") {
    buttons = (
      <>
        <button className="text-white font-bold h-12 px-4 rounded-md bg-blue-500 flex items-center justify-center gap-2">
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
          ...
          <p className="hidden sm:block">Mark All Read</p>
        </button>
      </>
    );
    ...
    buttons = (
      <>
        <button className="text-white font-bold h-12 px-4 rounded-md bg-blue-500 flex items-center justify-center gap-2">
          ...
          <p className="hidden sm:block">New Item</p>
        </button>
        <Search
    ...
    buttons = (
      ...
      >
        <p className="hidden sm:block">Ongoing Action</p>
      </button>
    );
  } else {
    buttons = null;
      ...
      <div className="h-screen p-6 overflow-hidden">
        ...
        <div className="w-full h-full flex flex-col gap-10">
          ...
          <div className="flex items-center justify-between pb-5 h-[10%] border-b-4 border-b-gray-200 w-full">
            ...
            <div className="w-1/2 flex flex-wrap gap-2 sm:gap-4 items-center justify-end">
              {buttons}
            </div>
          </div>
